...
namespace ASPNETCLINIC.Data.Migrations
{
    ...
    [Migration("20240830171341_dodanielocation")]
    partial class dodanielocation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASPNETCLINIC.Models.AppUsers", b =>
                {
            ...
            modelBuilder.Entity("ASPNETCLINIC.Models.Event", b =>
                {
                    ...
                    b.HasOne("ASPNETCLINIC.Models.AppUsers", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ASPNETCLINIC.Models.AppUsers", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
